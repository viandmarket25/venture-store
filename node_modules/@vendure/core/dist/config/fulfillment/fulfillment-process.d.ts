 ...
 * @since 2.0.0
 */
export interface FulfillmentProcess<State extends keyof CustomFulfillmentStates | string> extends InjectableStrategy {
 ...
 */
export interface CustomFulfillmentProcess<State extends keyof CustomFulfillmentStates | string> extends FulfillmentProcess<State> {
}
